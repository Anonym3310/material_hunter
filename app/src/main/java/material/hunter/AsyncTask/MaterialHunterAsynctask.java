...
public class MaterialHunterAsynctask
    extends AsyncTask<List<MaterialHunterModel>, Void, List<MaterialHunterModel>> {
  ...
  public MaterialHunterAsynctask(
      int actionCode,
      int position,
  ...
  protected List<MaterialHunterModel> doInBackground(
    ...
    switch (actionCode) {
      ...
      case MOVEDATA:
        materialhunterModelList = copyOfmaterialhunterModelList[0];
        if (materialhunterModelList != null) {
          MaterialHunterModel tempMaterialHunterModel =
              new MaterialHunterModel(
      ...
      case RESTOREDATA:
        ...
        if (materialhunterModelList != null) {
          ...
          materialhunterModelList =
              materialhunterSQL.bindData((ArrayList<MaterialHunterModel>) materialhunterModelList);
        }
        break;
      case RESETDATA:
        break;

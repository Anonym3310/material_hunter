...
public class ServicesData {
  ...
  public void refreshData() {
    ...
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
  ...
  public void startServiceforItem(int position, Switch mSwitch, Context context) {
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(ServicesAsyncTask.START_SERVICE_FOR_ITEM, position);
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {
  ...
  public void stopServiceforItem(int position, Switch mSwitch, Context context) {
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(ServicesAsyncTask.STOP_SERVICE_FOR_ITEM, position);
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {
  ...
  public void editData(int position, ArrayList<String> dataArrayList, ServicesSQL servicesSQL) {
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(ServicesAsyncTask.EDITDATA, position, dataArrayList, servicesSQL);
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void addData(int position, ArrayList<String> dataArrayList, ServicesSQL servicesSQL) {
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(ServicesAsyncTask.ADDDATA, position, dataArrayList, servicesSQL);
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void deleteData(
    ...
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(
            ServicesAsyncTask.DELETEDATA, selectedPositionsIndex, selectedTargetIds, servicesSQL);
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void moveData(
      int originalPositionIndex, int targetPositionIndex, ServicesSQL servicesSQL) {
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(
            ServicesAsyncTask.MOVEDATA, originalPositionIndex, targetPositionIndex, servicesSQL);
    servicesAsyncTask.setListener(
        new ServicesAsyncTask.ServicesAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public String restoreData(ServicesSQL servicesSQL, String storedDBpath) {
    ...
    if (returnedResult == null) {
      ServicesAsyncTask servicesAsyncTask =
          new ServicesAsyncTask(ServicesAsyncTask.RESTOREDATA, servicesSQL);
      servicesAsyncTask.setListener(
          new ServicesAsyncTask.ServicesAsyncTaskListener() {
            @Override
            public void onAsyncTaskPrepare() {}
  ...
  public void updateRunOnChrootStartServices(
    ...
    ServicesAsyncTask servicesAsyncTask =
        new ServicesAsyncTask(
            ServicesAsyncTask.UPDATE_RUNONCHROOTSTART_SCRIPTS,
            position,
            dataArrayList,
            servicesSQL);
    servicesAsyncTask.setListener(

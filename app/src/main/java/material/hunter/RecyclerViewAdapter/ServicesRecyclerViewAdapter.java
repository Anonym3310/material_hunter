...
public class ServicesRecyclerViewAdapter
  ...
  public ServicesRecyclerViewAdapter.ItemViewHolder onCreateViewHolder(
    ...
    View view =
        LayoutInflater.from(context)
            .inflate(R.layout.services_recyclerview_servicetitle, viewGroup, false);
  ...
  public void onBindViewHolder(@NonNull final ItemViewHolder itemViewHolder, int position) {
    ...
    itemViewHolder.nametextView.setOnLongClickListener(
        v -> {
          final ViewGroup nullParent = null;
          final LayoutInflater mInflater =
              (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
          final View promptViewEdit =
              mInflater.inflate(R.layout.services_edit_dialog_view, nullParent);
          ...
          final EditText checkstatusCmdEditText =
              promptViewEdit.findViewById(R.id.f_services_edit_adb_et_checkstatuscommand);
          final CheckBox runOnChrootStartCheckbox =
              promptViewEdit.findViewById(R.id.f_services_edit_adb_checkbox_runonboot);
          ...
          runOnChrootStartCheckbox.setChecked(
              ServicesData.getInstance()
                  .servicesModelListFull
                  .get(
                      ServicesData.getInstance()

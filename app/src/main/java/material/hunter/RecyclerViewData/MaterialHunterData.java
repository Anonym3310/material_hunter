...
public class MaterialHunterData {
  ...
  public static synchronized MaterialHunterData getInstance() {
    if (instance == null) {
  ...
  public void refreshData() {
    MaterialHunterAsynctask materialhunterAsynctask =
        new MaterialHunterAsynctask(MaterialHunterAsynctask.GETITEMRESULTS);
    materialhunterAsynctask.setListener(
        new MaterialHunterAsynctask.MaterialHunterAsynctaskListener() {
          @Override
  ...
  public void runCommandforItem(int position) {
    MaterialHunterAsynctask materialhunterAsynctask =
        new MaterialHunterAsynctask(MaterialHunterAsynctask.RUNCMDFORITEM, position);
    materialhunterAsynctask.setListener(
        new MaterialHunterAsynctask.MaterialHunterAsynctaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void editData(
      int position, ArrayList<String> dataArrayList, MaterialHunterSQL materialhunterSQL) {
    MaterialHunterAsynctask materialhunterAsynctask =
        new MaterialHunterAsynctask(
            MaterialHunterAsynctask.EDITDATA, position, dataArrayList, materialhunterSQL);
    materialhunterAsynctask.setListener(
        new MaterialHunterAsynctask.MaterialHunterAsynctaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void addData(
    ...
    MaterialHunterAsynctask materialhunterAsynctask =
        new MaterialHunterAsynctask(
            MaterialHunterAsynctask.ADDDATA, position, dataArrayList, materialhunterSQL);
    materialhunterAsynctask.setListener(
        new MaterialHunterAsynctask.MaterialHunterAsynctaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void deleteData(
      ...
      MaterialHunterSQL materialhunterSQL) {
    MaterialHunterAsynctask materialhunterAsynctask =
        new MaterialHunterAsynctask(
            MaterialHunterAsynctask.DELETEDATA,
  ...
  public void moveData(
      int originalPositionIndex, int targetPositionIndex, MaterialHunterSQL materialhunterSQL) {
    MaterialHunterAsynctask materialhunterAsynctask =
        new MaterialHunterAsynctask(
            MaterialHunterAsynctask.MOVEDATA,
  ...
  public String restoreData(MaterialHunterSQL materialhunterSQL, String storedDBpath) {
    ...
    if (returnedResult == null) {
      MaterialHunterAsynctask materialhunterAsynctask =
          new MaterialHunterAsynctask(MaterialHunterAsynctask.RESTOREDATA, materialhunterSQL);
      materialhunterAsynctask.setListener(
          new MaterialHunterAsynctask.MaterialHunterAsynctaskListener() {
            @Override
            public void onAsyncTaskPrepare() {}
  ...
  public void updateMaterialHunterModelListFull(

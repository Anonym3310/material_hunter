...
public class MaterialHunterRecyclerViewAdapterDeleteItems
    extends RecyclerView.Adapter<MaterialHunterRecyclerViewAdapterDeleteItems.ItemViewHolder> {

  private final Context context;
  private final List<MaterialHunterModel> materialhunterModelList;

  public MaterialHunterRecyclerViewAdapterDeleteItems(
  ...
  @NonNull
  @Override
  public MaterialHunterRecyclerViewAdapterDeleteItems.ItemViewHolder onCreateViewHolder(

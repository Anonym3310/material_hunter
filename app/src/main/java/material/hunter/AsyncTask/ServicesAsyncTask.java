...
public class ServicesAsyncTask extends AsyncTask<List<ServicesModel>, Void, List<ServicesModel>> {
  ...
  public ServicesAsyncTask(
      int actionCode, int position, ArrayList<String> dataArrayList, ServicesSQL servicesSQL) {
    this.actionCode = actionCode;
    this.position = position;
  ...
  public ServicesAsyncTask(
      int actionCode, int originalPositionIndex, int targetPositionIndex, ServicesSQL servicesSQL) {
    this.actionCode = actionCode;

    ...
    private void startMana() {
        ...
        builder.setPositiveButton("Start", (dialog, which) -> {
            switch (selectedScriptIndex) {
                ...
                case 0:
                    NhPaths.showSnack(getView(), "Starting MANA NAT FULL", 1);
                    ...
                    break;
                case 1:
                    NhPaths.showSnack(getView(), "Starting MANA NAT SIMPLE", 1);
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    break;
                case 2:
                    NhPaths.showSnack(getView(), "Starting MANA Bettercap", 1);
                    intentClickListener_NH(NhPaths.makeTermTitle("MANA-BETTERCAP") + "/usr/bin/start-nat-transproxy-lollipop.sh");
                    break;
                case 3:
                    NhPaths.showSnack(getView(), "Starting MANA NAT SIMPLE && BDF", 1);
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    new android.os.Handler().postDelayed(
                            () -> {
                                NhPaths.showSnack(getView(), "Starting MSF with BDF resource.rc", 1);
                                intentClickListener_NH(NhPaths.makeTermTitle("MSF") + "msfconsole -q -r /usr/share/bdfproxy/bdfproxy_msf_resource.rc");
                            }, 10000);
                    break;
                case 4:
                    NhPaths.showSnack(getView(), "Starting HOSTAPD-WPE", 1);
    ...
    public static class HostapdFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            button.setOnClickListener(v -> {
                ...
                TextInputEditText ifc = getView().findViewById(R.id.ifc);
                TextInputEditText bssid = getView().findViewById(R.id.bssid);
                TextInputEditText ssid = getView().findViewById(R.id.ssid);
                TextInputEditText channel = getView().findViewById(R.id.channel);
                TextInputEditText enableKarma = getView().findViewById(R.id.enable_karma);
                TextInputEditText karmaLoud = getView().findViewById(R.id.karma_loud);
        ...
        private void loadOptions(View rootView) {
            ...
            final TextInputEditText bssid = rootView.findViewById(R.id.bssid);
            final TextInputEditText ssid = rootView.findViewById(R.id.ssid);
            final TextInputEditText channel = rootView.findViewById(R.id.channel);
            final TextInputEditText enableKarma = rootView.findViewById(R.id.enable_karma);
            final TextInputEditText karmaLoud = rootView.findViewById(R.id.karma_loud);
    ...
    public static class HostapdFragmentWPE extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            button.setOnClickListener(v -> {
                ...
                TextInputEditText ifc = getView().findViewById(R.id.wpe_ifc);
                TextInputEditText bssid = getView().findViewById(R.id.wpe_bssid);
                TextInputEditText ssid = getView().findViewById(R.id.wpe_ssid);
                TextInputEditText channel = getView().findViewById(R.id.wpe_channel);
                TextInputEditText privatekey = getView().findViewById(R.id.wpe_private_key);
        ...
        private void loadOptions(View rootView) {
            ...
            final TextInputEditText ifc = rootView.findViewById(R.id.wpe_ifc);
            final TextInputEditText bssid = rootView.findViewById(R.id.wpe_bssid);
            final TextInputEditText ssid = rootView.findViewById(R.id.wpe_ssid);
            final TextInputEditText channel = rootView.findViewById(R.id.wpe_channel);
            final TextInputEditText privatekey = rootView.findViewById(R.id.wpe_private_key);

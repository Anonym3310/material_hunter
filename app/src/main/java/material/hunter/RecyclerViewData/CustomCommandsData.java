...
public class CustomCommandsData {
  ...
  public void runCommandforitem(int position, Context context) {
    CustomCommandsAsyncTask customCommandsAsyncTask =
        new CustomCommandsAsyncTask(CustomCommandsAsyncTask.RUNCMD, position, context);
    customCommandsAsyncTask.setListener(
        new CustomCommandsAsyncTask.CustomCommandsAsyncTaskListener() {
          @Override
  ...
  public void editData(
    ...
    CustomCommandsAsyncTask customCommandsAsyncTask =
        new CustomCommandsAsyncTask(
            CustomCommandsAsyncTask.EDITDATA, position, dataArrayList, customCommandsSQL);
    customCommandsAsyncTask.setListener(
        new CustomCommandsAsyncTask.CustomCommandsAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void addData(
    ...
    CustomCommandsAsyncTask customCommandsAsyncTask =
        new CustomCommandsAsyncTask(
            CustomCommandsAsyncTask.ADDDATA, position, dataArrayList, customCommandsSQL);
    customCommandsAsyncTask.setListener(
        new CustomCommandsAsyncTask.CustomCommandsAsyncTaskListener() {
          @Override
          public void onAsyncTaskPrepare() {}
  ...
  public void deleteData(
    ...
    CustomCommandsAsyncTask customCommandsAsyncTask =
        new CustomCommandsAsyncTask(
            CustomCommandsAsyncTask.DELETEDATA,
  ...
  public void moveData(
      int originalPositionIndex, int targetPositionIndex, CustomCommandsSQL customCommandsSQL) {
    CustomCommandsAsyncTask customCommandsAsyncTask =
        new CustomCommandsAsyncTask(
            CustomCommandsAsyncTask.MOVEDATA,
  ...
  public String restoreData(CustomCommandsSQL customCommandsSQL, String storedDBpath) {
    ...
    if (returnedResult == null) {
      CustomCommandsAsyncTask customCommandsAsyncTask =
          new CustomCommandsAsyncTask(CustomCommandsAsyncTask.RESTOREDATA, customCommandsSQL);
      customCommandsAsyncTask.setListener(
          new CustomCommandsAsyncTask.CustomCommandsAsyncTaskListener() {
            @Override
            public void onAsyncTaskPrepare() {}

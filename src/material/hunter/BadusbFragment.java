...
public class BadusbFragment extends Fragment {
    ...
    private void updateOptions() {
        ...
        if (r) {
            NhPaths.showSnack(getView(),"Options updated!",1);
        } else {
            NhPaths.showSnack(getView(),"Options not updated!",1);
        }
    }
    ...
    private void start() {
        ...
        NhPaths.showSnack(getView(),"BadUSB attack started! Check /sdcard/nh_files/badusb.log",2);
    }
    ...
    private void stop() {
        ...
        exe.RunAsRoot(command);
        NhPaths.showSnack(getView(),"BadUSB attack stopped!",1);
    }
}

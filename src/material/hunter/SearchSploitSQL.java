...
class SearchSploitSQL extends SQLiteOpenHelper {
    ...
    List<SearchSploit> getAllExploitsRaw(String filter) {
        String wildcard = "%" + filter + "%";
        String query = "SELECT * FROM " + SearchSploit.TABLE
                + " WHERE ( " + SearchSploit.DESCRIPTION + " like ? or " + SearchSploit.AUTHOR + " like ? or " + SearchSploit.TYPE + " like ? or " + SearchSploit.DATE + " like ? or " + SearchSploit.PLATFORM + " like ? ) GROUP BY " + SearchSploit.ID;
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    List<String> getDates() {
        String query = "SELECT DISTINCT " + SearchSploit.DATE + " FROM " + SearchSploit.TABLE + " ORDER BY " + SearchSploit.DATE + " ASC";
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(query, null);
        List<String> _List = createStringList(cursor);
        db.close();

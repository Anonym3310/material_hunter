...
public class MaterialHunterRecyclerViewAdapterResult
    extends RecyclerView.Adapter<MaterialHunterRecyclerViewAdapterResult.ItemViewHolder> {
  ...
  @NonNull
  @Override
  public MaterialHunterRecyclerViewAdapterResult.ItemViewHolder onCreateViewHolder(
      @NonNull ViewGroup parent, int viewType) {
    View view =
        LayoutInflater.from(context)
            .inflate(R.layout.materialhunter_recyclerview_result, parent, false);
    return new ItemViewHolder(view);
  }

  @Override
  public void onBindViewHolder(
      @NonNull MaterialHunterRecyclerViewAdapterResult.ItemViewHolder holder, int position) {

...
public class MaterialHunterSQL extends SQLiteOpenHelper {
    ...
    private static final String[][] materialhunterData = {
            ...
            {"6", "External IP", "curl ifconfig.me || echo \"No internet connection or busybox isn't installed.\"", "\\n", "0"}
    };
    ...
    public synchronized static MaterialHunterSQL getInstance(Context context) {
        if (instance == null) {
            instance = new MaterialHunterSQL(context.getApplicationContext());
        }
        return instance;
    }
    ...
    public String backupData(String storedDBpath) {
        try {
            String currentDBPath = Environment.getDataDirectory() + "/data/material.hunter/databases/" + getDatabaseName();

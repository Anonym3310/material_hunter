...
public class MaterialHunterRecyclerViewAdapter
    extends RecyclerView.Adapter<MaterialHunterRecyclerViewAdapter.ItemViewHolder>
    implements Filterable {

  private final Context context;
  private final List<MaterialHunterModel> materialhunterModelList;
  private final Filter MaterialHunterModelListFilter =
      new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
          ...
          if (constraint == null || constraint.length() == 0) {
            results.values =
                new ArrayList<>(MaterialHunterData.getInstance().materialhunterModelListFull);
          } else {
            String filterPattern = constraint.toString().toLowerCase().trim();
            List<MaterialHunterModel> tempMaterialHunterModelList = new ArrayList<>();
            for (MaterialHunterModel materialhunterModel :
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
          ...
          MaterialHunterData.getInstance()
              .getMaterialHunterModels()
              .getValue()
              .addAll((List<MaterialHunterModel>) results.values);
          MaterialHunterData.getInstance()
              .getMaterialHunterModels()
              .postValue(MaterialHunterData.getInstance().getMaterialHunterModels().getValue());
        }
      };

  public MaterialHunterRecyclerViewAdapter(
      Context context, List<MaterialHunterModel> materialhunterModelList) {
  ...
  @NonNull
  @Override
  public MaterialHunterRecyclerViewAdapter.ItemViewHolder onCreateViewHolder(
      @NonNull ViewGroup parent, int viewType) {
    View view =
        LayoutInflater.from(context)
            .inflate(R.layout.materialhunter_recyclerview_main, parent, false);
    return new ItemViewHolder(view);
  }

  @Override
  public void onBindViewHolder(
      @NonNull MaterialHunterRecyclerViewAdapter.ItemViewHolder holder, int position) {
    ...
    holder.titleTextView.setOnLongClickListener(
        v -> {
          ...
          final View promptViewEdit =
              mInflater.inflate(R.layout.materialhunter_edit_dialog_view, null);
    ...
    if (MaterialHunterData.getInstance()
        .materialhunterModelListFull
        .get(
            MaterialHunterData.getInstance()
                .materialhunterModelListFull
